...
notebook_path = "/content/sample_data/assignment_3_B00825518_CSCI4141.ipynb"
with open(notebook_path, 'r') as f:
    notebook = json.load(f)

# Fix or remove the 'metadata.widgets' section
if 'widgets' in notebook.get('metadata', {}):
    # Option 1: Remove it entirely
    del notebook['metadata']['widgets']

    # Option 2 (alternative): Insert a dummy valid state
